import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as React } from "./index-B1-BzShZ.js";
/**
...
function getScoreGaugeColor(score) {
...
function ScoreGauge({
  ...
  const [displayScore, setDisplayScore] = reactExports.useState(animated ? 0 : score);
  const [displayProgress, setDisplayProgress] = reactExports.useState(animated ? 0 : score);
  ...
  const color2 = getScoreGaugeColor(score);
  const cx2 = dim / 2;
  const cy = dim / 2;
  ...
  const trackX1 = cx2 + radius * Math.cos(startRad);
  const trackY1 = cy + radius * Math.sin(startRad);
  const trackX2 = cx2 + radius * Math.cos(endRad);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: trackX1, cy: trackY1, r: stroke / 2, fill: "var(--border)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: trackX2, cy: trackY2, r: stroke / 2, fill: "var(--border)" })
            ]
          }
        ),
